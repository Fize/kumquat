...
Kumquat Engine is the core system of the [Kumquat](../README_en.md) multi-cluster application management platform, responsible for application distribution, scheduling and management across multiple Kubernetes clusters.
...
See [../docs/en/index.md](../docs/en/index.md) for detailed documentation on architecture design, scheduler, API reference, etc.
