    ...
    "paths": {
        "/auth/change-password": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "{\\\"code\\\":0,\\\"message\\\":\\\"password changed successfully\\\"}",
                        "schema": {
                            "type": "object",
                    ...
                    "403": {
                        "description": "{\\\"code\\\":403,\\\"message\\\":\\\"旧密码错误\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/auth/login": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "{\\\"code\\\":0,\\\"data\\\":{\\\"token\\\":\\\"...\\\",\\\"user\\\":{...}}}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/auth/register": {
            "post": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "{\\\"code\\\":409,\\\"message\\\":\\\"用户名或邮箱已存在\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/modules": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{\\\"code\\\":0,\\\"data\\\":[{module_tree}]}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateModuleRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "{\\\"code\\\":0,\\\"data\\\":{module}}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "400": {
                        "description": "{\\\"code\\\":400,\\\"message\\\":\\\"请求参数错误或层级超限\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "403": {
                        "description": "{\\\"code\\\":403,\\\"message\\\":\\\"无权限\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/modules/{id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "{\\\"code\\\":400,\\\"message\\\":\\\"无效的模块ID\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "404": {
                        "description": "{\\\"code\\\":404,\\\"message\\\":\\\"模块不存在\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "{\\\"code\\\":0,\\\"message\\\":\\\"deleted\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/projects": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{\\\"code\\\":0,\\\"data\\\":[{project}],\\\"pagination\\\":{...}}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "{\\\"code\\\":0,\\\"data\\\":{project}}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "400": {
                        "description": "{\\\"code\\\":400,\\\"message\\\":\\\"请求参数错误\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/projects/{id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "{\\\"code\\\":400,\\\"message\\\":\\\"无效的项目ID\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "404": {
                        "description": "{\\\"code\\\":404,\\\"message\\\":\\\"项目不存在\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/roles/{id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "{\\\"code\\\":400,\\\"message\\\":\\\"无效的角色ID\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "404": {
                        "description": "{\\\"code\\\":404,\\\"message\\\":\\\"角色不存在\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/users": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{\\\"code\\\":0,\\\"data\\\":{users},\\\"pagination\\\":{...}}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/users/{id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "{\\\"code\\\":400,\\\"message\\\":\\\"无效的用户ID\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "{\\\"code\\\":403,\\\"message\\\":\\\"不能删除最后一个 admin 用户\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
    ...
    "definitions": {
        ...
        "handler.UpdateModuleRequest": {
            ...
            "properties": {
                "name": {
                    "type": "string",
                    "example": "infrastructure-updated"
                },
                "sort": {
                    "type": "integer",
                    "example": 1
