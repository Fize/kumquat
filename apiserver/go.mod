module github.com/fize/kumquat/apiserver

go 1.25.0

require (
	github.com/DATA-DOG/go-sqlmock v1.5.2
	github.com/fize/go-ext v0.2.0
	github.com/fize/kumquat/engine v0.0.0
...
replace github.com/fize/kumquat/engine => ../engine
