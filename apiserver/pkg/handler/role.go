...
func (c *RoleController) Create() (gin.HandlerFunc, error) {
	return methodNotAllowed("roles are predefined"), nil
}
func (c *RoleController) Update() (gin.HandlerFunc, error) {
	return methodNotAllowed("roles are predefined"), nil
}
func (c *RoleController) Delete() (gin.HandlerFunc, error) {
	return methodNotAllowed("roles are predefined"), nil
}
func (c *RoleController) Patch() (gin.HandlerFunc, error) {
	return methodNotAllowed("roles are predefined"), nil
}

func methodNotAllowed(message string) gin.HandlerFunc {
	return func(ctx *gin.Context) { utils.Error(ctx, 405, 405, message) }
}
